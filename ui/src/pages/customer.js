...
function Customer() {
  ...
  return (
    <MainDiv>
        <TopDiv><h3>Make an order (Team 1 Branch)</h3><div><SelectorBox people={customerArr} selectedCustomer={selectedCustomer} setSelectedCustomer={setSelectedCustomer}/></div></TopDiv>
      <div>
      <input
              id="itemName"
              name="itemName"
